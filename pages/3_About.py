...
- [N](https://ucucommons.org/tag/nec-report/)/[HEC](https://ucucommons.org/tag/hec-report/) reports. This a more recent effort to get out stuff about N/HEC meetings from the UCU Commons N/HEC members. (We, alas, don't have any FEC members but would happy to help support FEC reports.) This came out of frustration around the opacity of N/HEC decision making. Minutes are late and not very informative. We obviously have perspectives and understandings that we'd like to share. We take notes during the meeting in a share document then write things up to release roughly in conjunction with the draft minutes. (This has provided a bit of a forcing function on getting the draft minutes out.) There's a lot of factual info in these but they very much are "The UCU Commons view of the meeting", thus they equally give insight into *the meeting* and to *our thinking*. I don't think we distort, slant, or mislead in any way (not true of other reports and comments I've seen from other NEC members, i.e., I've had uncorrected untruths about things I've said circulated on Bluesky by NEC members.) I think these are great! I do very very little work on them :)
